...
const PALETTE = {
  emerald: {
    dark: {
      ...
      text: '#ffffff', text2: 'rgba(52,211,153,0.75)',
      ...
      hg: 'linear-gradient(135deg,#050a07 0%,#122018 50%,#34d399 110%)',
    ...
    light: {
      g: '#059669', gd: '#047857', gRgb: '5,150,105', gdRgb: '4,120,87',
      gl: 'rgba(5,150,105,0.12)', ink3: 'rgba(5,150,105,0.5)',
      bg: '#f0faf5', cardBg: 'rgba(255,255,255,0.95)',
      bg3: '#e4f4ec', bg4: '#d6ede3',
      border: 'rgba(5,150,105,0.28)',
      ink: '#daf0e5', ink2: '#e4f4ec',
      text: '#0f1a14', text2: 'rgba(5,150,105,0.85)',
      ...
      accent: '#059669', accent2: '#047857', accentBg: 'rgba(5,150,105,0.1)',
      green: '#059669', greenBg: 'rgba(5,150,105,0.12)',
      hg: 'linear-gradient(135deg,#daf0e5 0%,#d6ede3 50%,#059669 110%)',
      hga: 'linear-gradient(135deg,#059669 0%,#047857 100%)',
      mesh1: 'rgba(5,150,105,0.07)', mesh2: 'rgba(4,120,87,0.04)', mesh3: 'rgba(5,150,105,0.05)',
      glow: '0 0 0 1px rgba(5,150,105,0.2),0 0 32px rgba(5,150,105,0.12)',
    },
  },
  gold: {
    dark: {
