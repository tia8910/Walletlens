...
export const TRACK_COINS = [
  ...
  // $LENZ — WalletLens's own SNIP-20 privacy token (see /lenz and lenz-token/).
  ...
  // { slug: 'lenz', id: 'REPLACE_WITH_COINGECKO_ID', name: 'WalletLens', symbol: 'LENZ', type: 'crypto', blurb: 'the privacy token of the WalletLens ecosystem, a SNIP-20 on Secret Network with encrypted balances and transfers.' },
]
