  ...
  en: [
    ...
    ['Comparisons & Troubleshooting', [
      ...
      ['Is WalletLens open source?',
       'Yes. The source is public under the MIT licence.'],
      ['How do I report a bug or request a feature?',
       'Email contact@walletlens.live — we read everything.'],
    ]],
  ],
  ...
  ar: [
    ...
    ['المقارنات وحل المشكلات', [
      ...
      ['هل WalletLens مفتوح المصدر؟',
       'نعم. الشيفرة المصدرية متاحة بموجب رخصة MIT.'],
      ['كيف أبلّغ عن خلل أو أطلب ميزة؟',
       'راسلنا على contact@walletlens.live — نقرأ كل شيء.'],
    ]],
  ],
  ...
  fr: [
    ...
    ['Comparaisons et dépannage', [
      ...
      ['WalletLens est-il open source ?',
       "Oui. Le code source est public sous licence MIT."],
      ['Comment signaler un bug ou demander une fonctionnalité ?',
       "Écrivez à contact@walletlens.live — nous lisons tout."],
    ]],
  ],
  ...
  es: [
    ...
    ['Comparativas y resolución de problemas', [
      ...
      ['¿WalletLens es de código abierto?',
       'Sí. El código fuente es público bajo licencia MIT.'],
      ['¿Cómo informo de un fallo o pido una función?',
       'Escribe a contact@walletlens.live: lo leemos todo.'],
    ]],
  ],
}
