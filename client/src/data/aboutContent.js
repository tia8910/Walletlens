...
export const ABOUT_TEXT = {
  en: {
    ...
    blocks: [
      ...
      ['h2', 'Open Source'],
      ['p', 'WalletLens is open source under the MIT licence.'],
      ['h2', 'Contact'],
  ...
  ar: {
    ...
    blocks: [
      ...
      ['h2', 'مفتوح المصدر'],
      ['p', 'WalletLens مفتوح المصدر بموجب رخصة MIT.'],
      ['h2', 'تواصل معنا'],
  ...
  fr: {
    ...
    blocks: [
      ...
      ['h2', 'Open source'],
      ['p', "WalletLens est open source sous licence MIT."],
      ['h2', 'Contact'],
  ...
  es: {
    ...
    blocks: [
      ...
      ['h2', 'Código abierto'],
      ['p', 'WalletLens es de código abierto bajo licencia MIT.'],
      ['h2', 'Contacto'],
