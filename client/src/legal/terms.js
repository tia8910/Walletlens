...
export const terms = {
  ...
  de: {
    ...
    intro: 'Bitte lesen Sie diese Nutzungsbedingungen („Bedingungen“) sorgfältig, bevor Sie WalletLens („die App“, „wir“, „uns“) nutzen. Mit dem Zugriff auf WalletLens oder der Nutzung erklären Sie sich mit diesen Bedingungen einverstanden.',
    sections: [
      { h: '1. Beschreibung des Dienstes', p: ['WalletLens ist eine kostenlose, browserbasierte Anwendung zur Portfolioverfolgung, mit der Nutzer Anlagen über mehrere Anlageklassen hinweg erfassen und beobachten können, darunter Kryptowährungen, Aktien, Rohstoffe und Währungen. Die App läuft vollständig in Ihrem Browser; kein Server speichert Ihre Finanzdaten.'] },
      { h: '2. Nutzungsvoraussetzungen', p: ['Sie müssen mindestens 13 Jahre alt sein, um WalletLens zu nutzen. Mit der Nutzung der App versichern Sie, diese Altersgrenze zu erfüllen. Wenn Sie unter 18 sind, sollten Sie diese Bedingungen mit einem Elternteil oder Erziehungsberechtigten durchgehen.'] },
      { h: '3. Keine Finanzberatung', p: [
        'WalletLens ist ausschließlich ein Informationswerkzeug. Nichts auf der Plattform stellt eine Finanz-, Anlage-, Rechts- oder Steuerberatung dar. Alle Daten, KI-gestützten Erkenntnisse, Kursalarme, Risikowerte und Portfolioanalysen dienen allein der Information und sollten nicht als Grundlage für Anlageentscheidungen dienen.',
        'Recherchieren Sie stets selbst und ziehen Sie vor Anlageentscheidungen einen qualifizierten Finanzberater hinzu. In der App gezeigte Kennzahlen zur bisherigen Entwicklung sind keine Garantie für künftige Ergebnisse.',
      ] },
      { h: '4. Richtigkeit der Daten', p: ['Kursdaten stammen von Schnittstellen Dritter (CoinGecko, Binance, CoinCap, Gold-API, Stooq und weitere). WalletLens übernimmt keine Gewähr für Richtigkeit, Vollständigkeit, Aktualität oder Eignung der angezeigten Kurs- und Marktdaten. Für Schäden aus dem Vertrauen auf diese Daten übernehmen wir keine Verantwortung.'] },
      { h: '5. Ihre Daten', p: ['Alle von Ihnen eingegebenen Portfoliodaten werden lokal im `localStorage` Ihres Browsers gespeichert. Wir haben keinen Zugriff darauf. Sie sind allein dafür verantwortlich, mit der Exportfunktion der App Sicherungen anzulegen. Das Löschen Ihrer Browserdaten, der Wechsel auf ein neues Gerät oder das Entfernen der App löscht Ihre lokalen Daten endgültig, sofern Sie kein Backup exportiert haben.'] },
      { h: '6. Zulässige Nutzung', p: ['Sie verpflichten sich, Folgendes zu unterlassen:'], ul: [
        'Die App für rechtswidrige Zwecke oder unter Verstoß gegen geltendes Recht zu nutzen',
        'Zu versuchen, Teile der App zurückzuentwickeln, zu dekompilieren oder zu disassemblieren',
        'Automatisierte Werkzeuge einzusetzen, um über die App erreichte Schnittstellen Dritter auszulesen, zu überlasten oder zu missbrauchen',
        'Portfoliodaten falsch darzustellen oder die App zur Erleichterung von Finanzbetrug zu nutzen',
      ] },
      { h: '7. Geistiges Eigentum', p: ['Der Name WalletLens, das Logo, die Gestaltung der Oberfläche und der ursprüngliche Code sind Eigentum von WalletLens. Logos und Markenzeichen von Kryptowährungen Dritter gehören den jeweiligen Inhabern und werden zu Kennzeichnungszwecken im Rahmen der zulässigen Nutzung verwendet.'] },
      { h: '8. Dienste Dritter', p: ['WalletLens bindet Dienste Dritter für Marktkursdaten und Analyse ein (Google Analytics) sowie — für die in der Datenschutzerklärung genannten optionalen Funktionen — für E-Mail-Versand und KI-Verarbeitung. Ihre Nutzung der App unterliegt zusätzlich den Bedingungen und Datenschutzerklärungen dieser Dritten. Für deren Praktiken übernehmen wir keine Verantwortung. WalletLens zeigt in der App keine Werbung.'] },
      { h: '9. Gewährleistungsausschluss', p: ['WalletLens wird „wie besehen“ und „wie verfügbar“ bereitgestellt, ohne ausdrückliche oder stillschweigende Gewährleistung jeder Art. Wir sichern nicht zu, dass die App ununterbrochen, fehlerfrei oder frei von Viren läuft. Soweit gesetzlich zulässig, schließen wir alle Gewährleistungen aus, einschließlich stillschweigender Zusicherungen der Marktgängigkeit und der Eignung für einen bestimmten Zweck.'] },
      { h: '10. Haftungsbeschränkung', p: ['Soweit gesetzlich zulässig, haften WalletLens und seine Betreiber nicht für indirekte, zufällige, besondere, Folge- oder Strafschäden, einschließlich, aber nicht beschränkt auf entgangenen Gewinn, Datenverlust oder Wertverlust von Anlagen, die aus Ihrer Nutzung oder Nichtnutzbarkeit der App entstehen.'] },
      { h: '11. Änderungen des Dienstes', p: ['Wir behalten uns das Recht vor, jeden Teil von WalletLens jederzeit und ohne Vorankündigung zu ändern, auszusetzen oder einzustellen. Für Änderungen, Aussetzungen oder Einstellungen haften wir weder Ihnen noch Dritten gegenüber.'] },
      { h: '12. Änderungen dieser Bedingungen', p: ['Wir können diese Bedingungen von Zeit zu Zeit aktualisieren. Änderungen werden auf dieser Seite mit einem aktualisierten Datum veröffentlicht. Die weitere Nutzung der App nach Änderungen gilt als Zustimmung zu den überarbeiteten Bedingungen.'] },
      { h: '13. Anwendbares Recht', p: ['Diese Bedingungen unterliegen dem jeweils anwendbaren Recht und sind entsprechend auszulegen. Streitigkeiten aus diesen Bedingungen oder Ihrer Nutzung der App werden durch Verhandlungen nach Treu und Glauben oder, falls erforderlich, durch ein verbindliches Schiedsverfahren beigelegt.'] },
      { h: '14. Kontakt', p: ['Wenn Sie Fragen zu diesen Bedingungen haben, schreiben Sie uns bitte an [contact@walletlens.live](mailto:contact@walletlens.live).'] },
    ],
  },
  it: {
    title: 'Termini di servizio',
    updated: 'Ultimo aggiornamento: agosto 2026',
    intro: 'Leggi attentamente questi Termini di servizio («Termini») prima di usare WalletLens («l’app», «noi», «nostro»). Accedendo a WalletLens o usandola, accetti di essere vincolato da questi Termini.',
    sections: [
      { h: '1. Descrizione del servizio', p: ['WalletLens è un’applicazione gratuita per browser che consente di registrare e monitorare investimenti su più classi di attivo, tra cui criptovalute, azioni, materie prime e valute. L’app funziona interamente nel tuo browser; nessun server conserva i tuoi dati finanziari.'] },
      { h: '2. Requisiti di accesso', p: ['Per usare WalletLens devi avere almeno 13 anni. Usando l’app dichiari di soddisfare questo requisito di età. Se hai meno di 18 anni, dovresti leggere questi Termini insieme a un genitore o a un tutore.'] },
      { h: '3. Nessuna consulenza finanziaria', p: [
        'WalletLens è soltanto uno strumento informativo. Nulla sulla piattaforma costituisce consulenza finanziaria, di investimento, legale o fiscale. Tutti i dati, gli approfondimenti generati dall’IA, gli avvisi di prezzo, i punteggi di rischio e le analisi di portafoglio hanno finalità puramente informative e non devono essere usati come base per decisioni di investimento.',
        'Fai sempre le tue ricerche e consulta un consulente finanziario qualificato prima di qualsiasi decisione di investimento. Gli indicatori di rendimento passato mostrati nell’app non garantiscono risultati futuri.',
      ] },
      { h: '4. Accuratezza dei dati', p: ['I dati di prezzo provengono da API di terze parti (CoinGecko, Binance, CoinCap, Gold-API, Stooq e altre). WalletLens non garantisce accuratezza, completezza, tempestività o idoneità a qualsiasi scopo dei dati di prezzo o di mercato visualizzati. Non siamo responsabili di perdite derivanti dall’affidamento su questi dati.'] },
      { h: '5. I tuoi dati', p: ['Tutti i dati di portafoglio che inserisci sono conservati localmente nel `localStorage` del tuo browser. Noi non vi abbiamo accesso. Sei l’unico responsabile della conservazione delle copie di sicurezza tramite la funzione di esportazione dell’app. Cancellare i dati del browser, passare a un nuovo dispositivo o disinstallare l’app elimina definitivamente i dati locali, a meno che tu non abbia esportato un backup.'] },
      { h: '6. Uso consentito', p: ['Ti impegni a non:'], ul: [
        'Usare l’app per scopi illeciti o in violazione di qualsiasi legge o regolamento applicabile',
        'Tentare di decompilare, disassemblare o ricostruire il codice di qualsiasi parte dell’app',
        'Usare strumenti automatici per estrarre dati, sovraccaricare o abusare delle API di terze parti raggiunte tramite l’app',
        'Rappresentare in modo ingannevole i dati di portafoglio o usare l’app per agevolare frodi finanziarie',
      ] },
      { h: '7. Proprietà intellettuale', p: ['Il nome WalletLens, il logo, il design dell’interfaccia e il codice originale sono di proprietà di WalletLens. I loghi e i marchi di criptovalute di terze parti appartengono ai rispettivi titolari e sono usati a fini identificativi secondo i principi del fair use.'] },
      { h: '8. Servizi di terze parti', p: ['WalletLens si integra con servizi di terze parti per i dati di prezzo e per l’analisi (Google Analytics) e — per le funzioni facoltative elencate nell’informativa sulla privacy — per l’invio di email e l’elaborazione con IA. L’uso dell’app è soggetto anche ai termini e alle informative sulla privacy di questi soggetti terzi. Non siamo responsabili delle loro pratiche. WalletLens non mostra pubblicità nell’app.'] },
      { h: '9. Esclusione di garanzie', p: ['WalletLens è fornita «così com’è» e «come disponibile», senza garanzie di alcun tipo, esplicite o implicite. Non garantiamo che l’app sia ininterrotta, priva di errori o priva di virus. Nella massima misura consentita dalla legge applicabile, escludiamo ogni garanzia, comprese quelle implicite di commerciabilità e idoneità a uno scopo particolare.'] },
      { h: '10. Limitazione di responsabilità', p: ['Nella massima misura consentita dalla legge, WalletLens e i suoi gestori non sono responsabili per danni indiretti, incidentali, speciali, consequenziali o punitivi, inclusi a titolo esemplificativo la perdita di profitti, di dati o di valore degli investimenti, derivanti dall’uso o dall’impossibilità di usare l’app.'] },
      { h: '11. Modifiche al servizio', p: ['Ci riserviamo il diritto di modificare, sospendere o interrompere qualsiasi aspetto di WalletLens in qualsiasi momento e senza preavviso. Non saremo responsabili nei tuoi confronti né verso terzi per alcuna modifica, sospensione o interruzione.'] },
      { h: '12. Modifiche a questi Termini', p: ['Potremmo aggiornare questi Termini di tanto in tanto. Le modifiche saranno pubblicate su questa pagina con una data di aggiornamento. L’uso continuato dell’app dopo le modifiche costituisce accettazione dei Termini rivisti.'] },
      { h: '13. Legge applicabile', p: ['Questi Termini sono regolati e interpretati secondo la legge applicabile. Eventuali controversie derivanti da questi Termini o dall’uso dell’app saranno risolte mediante negoziazione in buona fede o, se necessario, mediante arbitrato vincolante.'] },
      { h: '14. Contatti', p: ['Per qualsiasi domanda su questi Termini scrivici a [contact@walletlens.live](mailto:contact@walletlens.live).'] },
    ],
  },
}
