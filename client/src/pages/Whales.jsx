            ...
            {volumeAnomalies.map(c => (
              <div key={c.id} className="whale-row">
                <Link to={`/asset/${c.id}`} className="whale-coin">
                  <img src={c.image} alt="coin logo" width={26} height={26}  onError={e => { e.currentTarget.style.display = 'none' }} loading="lazy" decoding="async" />
                  <div>
          ...
          <div className="trending-grid">
            ...
            {trending.map((coin, i) => (
              <Link key={coin.id || i} to={`/asset/${coin.id}`} className="trending-card">
                ...
                <img src={coin.thumb} alt="coin logo" width={32} height={32}  onError={e => { e.currentTarget.style.display = 'none' }} loading="lazy" decoding="async" />
          ...
          {exchangeFlows.map((ex, i) => (
            <div key={ex.id} className="exchange-row">
              ...
              <div className="exchange-logo">
                {ex.image ? <img src={ex.image} alt="coin logo" width={28} height={28}  onError={e => { e.currentTarget.style.display = 'none' }} loading="lazy" decoding="async" /> : <span className="exchange-logo-placeholder"><Icon name="bank" size={18} /></span>}
              </div>
