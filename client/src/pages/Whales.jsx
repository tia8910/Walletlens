            ...
            {volumeAnomalies.map(c => (
              <div key={c.id} className="whale-row">
                <Link to={`/asset/${c.id}`} className="whale-coin">
                  <img src={c.image} alt="" width={26} height={26} loading="lazy" decoding="async" />
                  <div>
          ...
          <div className="trending-grid">
            {trending.map((t, i) => (
              <Link key={t.id || i} to={`/asset/${t.id}`} className="trending-card">
                ...
                <img src={t.thumb} alt="" width={32} height={32} loading="lazy" decoding="async" />
          ...
          {exchangeFlows.map((ex, i) => (
            <div key={ex.id} className="exchange-row">
              ...
              <div className="exchange-logo">
                {ex.image ? <img src={ex.image} alt="" width={28} height={28} loading="lazy" decoding="async" /> : <span className="exchange-logo-placeholder"><Icon name="bank" size={18} /></span>}
              </div>
