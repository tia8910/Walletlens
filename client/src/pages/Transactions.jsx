    ...
    <div className="page">
      ...
      {transactions.length === 0 ? (
        ...
        <div className="tx-list">
          {transactions.map(t => (
            <TxRow key={t.id} t={t} onDelete={handleDelete} />
          ))}
        </div>
      )}
...
// Memoized so editing the add-form or searching for a coin (both live in
// Transactions' own state) doesn't re-render every row in a long trade history.
const TxRow = memo(function TxRow({ t, onDelete }) {
