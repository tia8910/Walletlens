...
import { isAndroidTWA, isInstalledApp } from '../nativeBridge'
...
export default function Landing() {
  ...
  useEffect(() => {
    ...
    // isInstalledApp covers the PWA installs and the app's own WebView, which
    // reports display-mode: browser and would otherwise be shown a Play badge
    // by the app it is already running inside.
    setIsApp(isInstalledApp() || isAndroidTWA())
  }, [])
