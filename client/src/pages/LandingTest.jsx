...
const FEATURES = [
  ...
  { emoji: '🌡️', title: 'Market Mood Dial',      desc: 'A live Fear & Greed gauge that scores dozens of crypto headlines in real time — pure sentiment analysis. Know the crowd before you trade.', color: '#ea580c', bg: '#ffedd5' },
  ...
  { emoji: '🔓', title: 'Token Unlock Alarms',   desc: '20 major tokens tracked for upcoming unlock cliffs. See severity, monthly unlock %, and exact date — no surprises on unlock day.', color: '#dc2626', bg: '#fee2e2' },
