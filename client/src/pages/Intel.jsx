        ...
        {gems.map(c => (
          <Link key={c.id} to={`/asset/${c.id}`} className="gem-card">
            <div className="gem-score-ring" style={{ '--gem-score': c.gemScore }}>
              ...
              <img src={c.image} alt="coin logo" className="gem-img" loading="lazy" decoding="async" onError={e => { e.currentTarget.style.display = 'none' }} />
            </div>
          ...
          <Link key={i} to={`/asset/${s.coin.id}`} className="alpha-card">
            ...
            <div className="alpha-content">
              ...
              <div className="alpha-name">
                {s.coin.image && <img src={s.coin.image} alt="coin logo" width={18} height={18} style={{borderRadius:'50%',marginRight:6}} loading="lazy" decoding="async" onError={e => { e.currentTarget.style.display = 'none' }} />}
        ...
        {top10.map(c => {
          ...
          return (
            <Link key={c.id} to={`/asset/${c.id}`} className="ind-mom-row">
              <img src={c.image} alt="coin logo" width={20} height={20} style={{borderRadius:'50%'}} loading="lazy" decoding="async" onError={e => { e.currentTarget.style.display = 'none' }} />
