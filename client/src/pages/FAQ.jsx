...
// One source of truth for the on-page FAQ. The prerendered /faq/ shell
// (client/scripts/prerender.mjs) mirrors these questions in FAQPage JSON-LD —
...
export const FAQ_SECTIONS = [
  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: 'Usually the asset is custom (bonds, real estate) and needs a manual price — edit the holding to set its current value. For listed assets, a hard refresh (Ctrl+Shift+R) typically restores live prices; the app retries several sources automatically.',
      },
      {
  ...
  {
    title: 'Comparisons & Troubleshooting',
    faqs: [
      {
...
export default function FAQ() {
  useEffect(() => {
    document.title = 'FAQ — WalletLens Free Net Worth Tracker'
  }, [])
  ...
  return (
    <div className="doc-page">
      ...
      <article className="doc-article">
        ...
        <p className="doc-meta">Everything about tracking your net worth with WalletLens — free, private, no account</p>
        ...
        <p>
          Email us at <a href="mailto:contact@walletlens.live">contact@walletlens.live</a>, read more on the{' '}
          <Link to="/about/">About page</Link>, or browse the <Link to="/blog/">investing guides on the blog</Link>.
          Ready to start? <Link to="/dashboard/">Open WalletLens free</Link> — no account needed.
        </p>
      </article>
