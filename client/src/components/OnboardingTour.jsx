...
const STEPS = [
  ...
  },
  {
    ...
    icon: 'home',
    title: 'Portfolio Hub',
    desc: 'Total value, portfolio analysis, price alerts, and risk scores — all in one glance.',
    cta: 'Got it →',
    accent: '#60a5fa',
  },
  {
  ...
  },
  {
    ...
    desc: 'smart Alpha Score, hidden gems, and smart money signals — all for your portfolio.',
    cta: 'Got it →',
    accent: '#a78bfa',
  },
  {
    ...
    desc: 'Risk Scanner catches scams & rug pulls. Advisor gives personalised portfolio recommendations. Academy sharpens your crypto IQ.',
    cta: 'Got it →',
    accent: '#f87171',
