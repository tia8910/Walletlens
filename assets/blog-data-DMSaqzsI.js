const u=new Set("the a an and or of to in for your you how what is are be on with that this it as at by from across into not but new — your guide complete".split(" "));function s(o){return new Set(`${o.title} ${o.summary}`.toLowerCase().replace(/[^a-z0-9 ]/g," ").split(/\s+/).filter(t=>t.length>3&&!u.has(t)))}function d(o,t=3){const i=r.findIndex(e=>e.slug===o);if(i<0)return r.slice(0,t);const l=s(r[i]);return r.map((e,a)=>{if(a===i)return null;const c=s(e);let n=0;for(const h of c)l.has(h)&&n++;return{p:e,overlap:n,i:a}}).filter(Boolean).sort((e,a)=>a.overlap-e.overlap||e.i-a.i).slice(0,t).map(e=>e.p)}const r=[{slug:"how-to-track-crypto-portfolio-free",title:"How to Track Your Crypto Portfolio for Free in 2026",date:"May 2026",readTime:"5 min read",summary:"A complete guide to tracking Bitcoin, Ethereum, and altcoin holdings without paying for a subscription or giving up your private keys.",content:`
...
See your personalised Fear & Greed gauge and portfolio analytics at [walletlens.live](https://walletlens.live) — free, no sign-up required.
    `},{slug:"portfolio-diversification-crypto-stocks-gold",title:"How to Diversify Your Portfolio Across Crypto, Stocks, and Gold",date:"May 2026",readTime:"6 min read",summary:"Diversification across asset classes reduces risk without necessarily reducing returns. Here's a practical framework for balancing crypto, equities, and hard assets.",content:`
...
Most portfolio trackers only cover one asset class. WalletLens was specifically built to track crypto, stocks, gold, silver, bonds, and fiat currencies in a single unified dashboard with live prices — giving you a complete picture of your total net worth across every asset class. Start free at [walletlens.live](https://walletlens.live).
    `},{slug:"how-to-set-crypto-profit-targets",title:"How to Set Crypto Profit Targets (And Actually Stick to Them)",date:"May 2026",readTime:"5 min read",summary:"Most crypto investors buy well but sell poorly — either too early or, more often, too late. A systematic profit-taking plan removes emotion from the decision.",content:`
...
Your net worth is the sum of everything across all the accounts and assets you hold. Seeing it clearly — categorised, live-priced, allocation-weighted — takes no more than fifteen minutes to set up and dramatically improves every subsequent financial decision you make. Stop guessing at the total and start tracking it in one place at [walletlens.live](https://walletlens.live) — free, no account needed.
    `},{slug:"is-it-safe-to-connect-exchange-api-to-portfolio-tracker",title:"Is It Safe to Connect Your Exchange API to a Portfolio Tracker?",date:"May 2026",readTime:"7 min read",summary:"Thinking about linking your exchange API to a portfolio tracker? Learn the real risks, what to check, and safer alternatives before you connect.",content:`
...
Visit [walletlens.live](https://walletlens.live) to track AAPL alongside your entire portfolio — free, no account needed. Open the [Apple stock tracker](/track/apple-stock) page or the [dashboard](/dashboard) directly.
    `},{slug:"gold-silver-portfolio-tracker",title:"Gold and Silver Portfolio Tracker — Track Precious Metals for Free",date:"June 2026",readTime:"5 min read",summary:"Track your gold and silver holdings for free alongside crypto and stocks — see your precious metals P&L with live prices.",content:`
...
Track your actual crypto allocation alongside stocks, gold, and cash at [walletlens.live](https://walletlens.live) — free, no account needed.
    `},{slug:"best-free-investment-tracker-2026",title:"The Best Free Investment Tracker for Stocks, Crypto, and Gold (2026)",date:"June 2026",readTime:"5 min read",summary:"What to look for in a free investment portfolio tracker and why most popular options still have significant trade-offs.",content:`
...
See your live allocation breakdown and rebalance signals free at [walletlens.live](https://walletlens.live) — no account needed.
    `},{slug:"build-first-investment-portfolio",title:"How to Build Your First Investment Portfolio and Track It Free",date:"June 2026",readTime:"6 min read",summary:"A beginner-friendly guide to building a diversified first portfolio with index funds, crypto, and a gold allocation — and how to track it all for free.",content:`
...
The biggest advantage is seeing your crypto alongside everything else. Once your crypto is in WalletLens, add your stock ETFs, gold, and cash. The result is a live net-worth dashboard that no exchange app can provide — and you got there without connecting a single account. Start at [walletlens.live](https://walletlens.live), free.
    `},{slug:"precious-metals-vs-crypto",title:"Precious Metals vs Crypto: Which to Hold (and How to Track Both)",date:"June 2026",readTime:"6 min read",summary:"Gold, silver, Bitcoin, and Ethereum compared as store-of-value assets — different risk profiles, different roles, and why many investors hold both.",content:`
...
`},{slug:"crypto-withdrawal-strategy",title:"Crypto Withdrawal Strategy: How to Plan a Sustainable Drawdown",date:"June 2026",readTime:"7 min read",summary:"A step-by-step guide to planning when and how to withdraw from your crypto portfolio — without running out too soon or leaving too much on the table.",content:`
...
`},{slug:"net-worth-goal-buckets",title:"How to Split Your Net Worth Into Goals (and Actually Stick to Them)",date:"June 2026",readTime:"5 min read",summary:"Stop treating your portfolio as one big number. This guide shows how to divide your net worth into goal-based buckets that give every dollar a purpose and keep you disciplined.",content:`
